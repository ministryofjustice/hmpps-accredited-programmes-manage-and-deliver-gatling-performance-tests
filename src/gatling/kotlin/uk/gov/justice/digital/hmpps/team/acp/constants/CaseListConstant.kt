...
val NO_OF_CASE_LIST_USERS: Int = ConfigResolver.get("case_list_concurrent_users")?.toIntOrNull() ?: 2
val CASE_LIST_TEST_DURATION_MINUTES: Long = ConfigResolver.get("case_list_test_duration_minutes")?.toLongOrNull() ?: 5L
